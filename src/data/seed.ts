...
export const INITIAL_TASKS: Task[] = [
  {
    ...
    comments: [
      {
        id: 'comm-1-1',
        author: 'Founder A (Tech)',
        content: 'All 18 tools successfully passed schema validation suite. Zero regressions.',
      ...
      },
      {
        id: 'comm-1-2',
        author: 'Forge Agent',
        content: 'Validated with sample MCP client payloads. Boundary edge-cases return clean VALIDATION_ERROR codes.',
  ...
  },
  {
    ...
    comments: [
      {
        id: 'comm-2-1',
        author: 'Founder B (Product)',
        content: 'Diff viewer styling is aligned with the design system. Working on rollback hook now.',
      ...
      },
      {
        id: 'comm-2-2',
        author: 'Founder A (Tech)',
        content: 'Remember that takeSnapshot captures the complete state object, so rollback is an atomic O(1) swap.',
    ...
    comments: [
      {
        id: 'comm-3-1',
        author: 'Founder B (Product)',
        content: 'Hook drafts are ready. Let us showcase the voice-to-action flow first.',
